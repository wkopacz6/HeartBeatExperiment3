...
from pylsl import StreamInfo, StreamOutletinfo = StreamInfo(name='HeartStream', type='Markers', channel_count=1,                  channel_format='int32', source_id='uniqueid12345')# Initialize the stream.outlet = StreamOutlet(info)
...
expName = 'HeartBeat2_1'  # from the Builder filename that created this script
...
filename = _thisDir + os.sep + u'Heartdata1/%s_%s_%s' % (expInfo['participant'], expName, expInfo['date'])

# An ExperimentHandler isn't essential but helps with data saving
thisExp = data.ExperimentHandler(name=expName, version='',
    extraInfo=expInfo, runtimeInfo=None,
    originPath='/Users/walterkopacz/anaconda2/envs/psychopy/conda-meta/HeartBeat2_1.py',
...
choice1 = visual.TextStim(win=win, name='choice1',
    text='default text',
    font='Arial',
    units='cm', pos=(0, 4), height=1.5, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    depth=-1.0);
choice2 = visual.TextStim(win=win, name='choice2',
    text='default text',
    font='Arial',
    units='cm', pos=(0, 2), height=1.5, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    depth=-2.0);
choice3 = visual.TextStim(win=win, name='choice3',
    text='default text',
    font='Arial',
    units='cm', pos=(0, 0), height=1.5, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    depth=-3.0);
...
Question = visual.TextStim(win=win, name='Question',
    text='Rate on a scale of 1 to 5 how strongly you felt what this person felt.',
    font='Arial',
    pos=(0, 0), height=0.1, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    depth=0.0);
...
for thisTrial in trials:
    ...
    # keep track of which components have finished
    RateComponents = [Answer, choice1, choice2, choice3, choice4]
    ...
    # keep track of which components have finished
    EmpRateComponents = [Question, EmpAnswer]
