...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/walterkopacz/Desktop/conda-meta/HeartBeat3_lastrun.py',
...
trialsListen = data.TrialHandler(nReps=1, method='fullRandom', 
